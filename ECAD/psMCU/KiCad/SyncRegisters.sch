...
Comment2 ""
Comment3 ""
Comment4 "Registers to latch data/adr for RAM access."
$EndDescr
...
F 1 "SN74LVC1G04DCK" H 2200 4200 50  0000 C CNN
...
F 1 "+5V" H 1742 4087 50  0000 R CNN
...
F 0 "C68" V 1721 4100 50  0000 C CNN
F 1 "0u1" V 1812 4100 50  0000 C CNN
...
F 0 "C70" V 3971 850 50  0000 C CNN
F 1 "0u1" V 4062 850 50  0000 C CNN
...
F 1 "CD74HC173PW" H 4350 2550 50  0000 C CNN
...
F 0 "C71" V 3971 3100 50  0000 C CNN
...
F 1 "+5V" H 3992 3087 50  0000 R CNN
...
F 1 "CD74HC173PW" H 4350 4800 50  0000 C CNN
...
F 0 "C72" V 3971 5500 50  0000 C CNN
F 1 "0u1" V 4062 5500 50  0000 C CNN
...
F 1 "+5V" H 3992 5487 50  0000 R CNN
...
F 1 "CD74HC173PW" H 4350 7200 50  0000 C CNN
...
F 0 "C73" V 3971 7750 50  0000 C CNN
F 1 "0u1" V 4062 7750 50  0000 C CNN
...
F 1 "+5V" H 3992 7737 50  0000 R CNN
...
F 1 "CD74HC173PW" H 4350 9450 50  0000 C CNN
...
F 0 "C69" V 1721 6500 50  0000 C CNN
...
F 1 "SN74LVC1G04DCK" H 2200 6600 50  0000 C CNN
...
Text GLabel 2500 9300 0    31   Input ~ 0
RESET_A
Text GLabel 2500 9100 0    31   Input ~ 0
CLK_A
Wire Bus Line
	5150 5600 5150 8500
Wire Bus Line
