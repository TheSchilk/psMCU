...
Comp "Philipp Schilk"
Comment1 ""
Comment2 "can be set using SMT jumpers."
Comment3 "from an external remote control. The default state during power-on"
Comment4 "A button that toggles a state on/off. Handles de-bounce and accepts the signal"
$EndDescr
$Comp
L Switch:SW_Push SW?
U 1 1 5FEDE52F
