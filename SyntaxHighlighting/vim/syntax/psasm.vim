...
syn keyword psASM_OP_OP AND ANDL OR ORL XOR XORL SHFTR SHFTRL SHFTL SHFTLL COMPB COMPBC ADD ADDC ADDLA ADDLAC ADDLB ADDLB NOTA SUB SUBC SUBL SUBLC LITA LITB CPY SWP
