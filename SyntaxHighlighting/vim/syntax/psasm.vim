...
syn keyword psASM_OP_OP AND ANDL OR ORL XOR XORL SHFTR SHFTRL SHFTL SHFTLL ADD ADDL NOTA COMPB SUB SUB LITA LITB CPY SWP
syn keyword psASM_OP_DATA SVA SVB LDA LDB SVDP SVDR LDDP LDDR POP PUSH 
