...
syn keyword psASM_OP_OP AND ANDL OR ORL XOR XORL SHFTR SHFTRL SHFTL SHFTLL ADD ADDC ADDLA ADDLAC ADDLB ADDLB NOTA COMPB SUB SUBC SUBL SUBLC LITA LITB CPY SWP
